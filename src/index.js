...
<section class="section reveal visible" id="standard">
  <div class="flex-grid">
    ...
    <article class="flex-card">
      ...
      <h3>Focus</h3>
      <p>Choose what matters. Cut the noise. Set the target.</p>
    </article>
...
<section class="hero">
  ...
  <!-- NEW HERO VIDEO - ADDED, NOT REPLACING ANYTHING -->
  <div class="hero-video-container">
    ...
    >
      <source src="/flex-hero-web.mp4" type="video/mp4">
...
<section class="section reveal" id="journey">
  ...
  <h2 class="heading">Your FLEX Journey</h2>

  <p class="sub">
    Start with seven days. Build momentum. Lock in the habit.
    Earn the next level.
  </p>

  <div class="journey" id="journeyTrack">
    ...
    <div class="tier">
      ...
      <div class="tier-card">
        <strong>7-Day Foundation</strong>
        <span>Start small. Establish your daily standard.</span>
      </div>
    </div>
    ...
    <div class="tier">
      ...
      <div class="tier-card">
        <strong>14-Day Momentum</strong>
        <span>Build on the foundation and keep moving.</span>
      </div>
    </div>
    ...
    <div class="tier">
      ...
      <div class="tier-card">
        <strong>21-Day Habit Lock</strong>
        <span>
          Turn consistent action into a repeatable discipline.
        </span>
      </div>
    </div>
    ...
    <div class="tier lock">
      ...
      <div class="tier-card">
        <strong>28-Day Mastery 🔒</strong>
        <span>
          Complete the free path to unlock the next level.
        </span>
      </div>
    </div>
...
<section class="cta reveal">
  ...
  <h2>Become Your Standard.</h2>

  <p style="color:var(--muted);margin-top:.5rem">
    Seven days. One decision each day. Start building the person
    you want to become.
  </p>
...
<title>
  ${isStandardPage ? 'The Standard' : 'The Flex Standard'}
...
.flex-card {
  background:
    linear-gradient(145deg,var(--card),#101010);
  border:1px solid var(--border);
  border-radius:16px;
  padding:1.6rem;
  position:relative;
...
.journey-fill {
  ...
  height:0;
  background:
    linear-gradient(var(--gold),var(--gold2));
