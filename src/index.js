export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === '/hero-video-20260824.mp4') {
...
<section class="cta reveal visible"><h2>Live The Standard.</h2><p style="color:var(--muted);margin-top:.5rem">Know the principles. Put them into practice one day at a time.</p><a href="/">BACK TO HOME</a></section>`
      : `<section class="hero"><div class="hero-banner-container"><img src="/hero-banner.png" alt="The Flex Standard - Become Your Standard, Live the Flex" class="hero-banner-img"></div><div class="hero-video-container"><video class="hero-video" autoplay muted loop playsinline preload="metadata"><source src="/hero-video-20260824.mp4" type="video/mp4"></video></div><div class="badge">Free 7-Day Foundation</div><h1>Focus. Learn. Execute. Excel.</h1></section>
