...
function challengePage(days) {
  ...
  const reqKey = req ? CHALLENGE_KEYS[req] : '';
...
const TOTAL=${days},KEY='${c.key}',REQ=${req},REQKEY='${reqKey}',root=document.getElementById('days');
